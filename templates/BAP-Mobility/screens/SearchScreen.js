...
const SearchScreen = () => {
  ...
  const handleSearch = async() => {
    ...
    try{
      ...
      const  data  = await beckn.searchProviders(to, gps);
      console.log('\nFrontend: ', data);
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.searchContainer}>
        ...
        <View>
          ...
          <Text style={styles.orangeTxt}>Mobility</Text>
          <Text style={styles.blackTxt}>for All</Text>
        </View>

        <View style={styles.infoContainer}>
          <Text style={styles.info}>
            A global marketplace to discover mobility services you need. Just
            type your destination and we will take care of the rest.
          </Text>
        </View>
